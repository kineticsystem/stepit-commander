...
start. That makes 11 × 11 = 121 positions. Joints 3, 4 and 5 stay in place.
...
of joint2 is a trapezoid over 5 turns, about 3.4 s. The whole grid takes about
2.5 minutes. It has not run on the robot yet.
